...
contract GovernorAlpha2 {
    ...
    string public constant name = "LmnFi Governor Alpha";
    ...
    /// @notice The address of the LmnFi Protocol Timelock
    TimelockInterface public timelock;

    /// @notice The address of the LmnFi governance token
    LUMENInterface public lumen;
    ...
    constructor(address timelock_, address lumen_, address guardian_, uint256 lastProposalId_) public {
        timelock = TimelockInterface(timelock_);
        lumen = LUMENInterface(lumen_);
        guardian = guardian_;
    ...
    function propose(
        ...
        require(
            lumen.getPriorVotes(msg.sender, sub256(block.number, 1)) > proposalThreshold(),
    ...
    function cancel(uint proposalId) public {
        ...
        require(
            msg.sender == guardian ||
                lumen.getPriorVotes(proposal.proposer, sub256(block.number, 1)) < proposalThreshold(),
    ...
    function _castVote(address voter, uint proposalId, bool support) internal {
        ...
        uint96 votes = lumen.getPriorVotes(voter, proposal.startBlock);

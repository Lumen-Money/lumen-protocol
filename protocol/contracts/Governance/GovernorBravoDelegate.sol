...
contract GovernorBravoDelegate is GovernorBravoDelegateStorageV2, GovernorBravoEvents {
    ...
    string public constant name = "LmnFi Governor Bravo";

    /// @notice The minimum setable proposal threshold
    uint public constant MIN_PROPOSAL_THRESHOLD = 150000e18; // 150,000 Lumen

    /// @notice The maximum setable proposal threshold
    uint public constant MAX_PROPOSAL_THRESHOLD = 300000e18; //300,000 Lumen
    ...
    uint public constant quorumVotes = 600000e18; // 600,000 = 2% of Lumen
     ...
     * @param lumenVault_ The address of the LumenVault
    ...
    function initialize(
        ...
        require(lumenVault_ != address(0), "GovernorBravo::initialize: invalid lumen address");
        ...
        lumenVault = LumenVaultInterface(lumenVault_);
     ...
     * @param values NEON values for proposal calls
    ...
    function propose(
        ...
        require(
            lumenVault.getPriorVotes(msg.sender, sub256(block.number, 1)) >=
    ...
    function cancel(uint proposalId) external {
        ...
        require(
            msg.sender == guardian ||
                ...
                lumenVault.getPriorVotes(proposal.proposer, sub256(block.number, 1)) <
    ...
    function castVoteInternal(address voter, uint proposalId, uint8 support) internal returns (uint96) {
        ...
        uint96 votes = lumenVault.getPriorVotes(voter, proposal.startBlock);

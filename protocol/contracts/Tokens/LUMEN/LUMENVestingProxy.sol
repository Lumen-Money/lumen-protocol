...
contract LUMENVestingProxy is LUMENVestingAdminStorage {
    /**
    ...
    /**
     * @notice Emitted when pendingImplementation is accepted, which means LUMENVesting implementation is updated
     */
    ...
    constructor(
    ...
    ) nonZeroAddress(implementation_) nonZeroAddress(_lumenAddress) {
        ...
        delegateTo(implementation_, abi.encodeWithSignature("initialize(address)", _lumenAddress));
    }
    ...
    function _setImplementation(address implementation_) public {
        require(msg.sender == admin, "LUMENVestingProxy::_setImplementation: admin only");
        require(implementation_ != address(0), "LUMENVestingProxy::_setImplementation: invalid implementation address");

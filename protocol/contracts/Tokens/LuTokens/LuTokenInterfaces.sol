...
abstract contract LuTokenStorage {
    /**
    ...
    /**
     * @notice Contract which oversees inter-luToken operations
     */
    ...
    /**
     * @notice Initial exchange rate used when minting the first LuTokens (used when totalSupply = 0)
     */
...
abstract contract LuTokenInterface is LuTokenStorage {
    /**
     * @notice Indicator that this is a luToken contract (for inspection)
     */
    bool public constant isLuToken = true;
...
abstract contract LuErc20Interface is LuErc20Storage {
    /*** User Interface ***/
...
abstract contract LuDelegatorInterface is LuDelegationStorage {
    /**
...
abstract contract LuDelegateInterface is LuDelegationStorage {
    /**

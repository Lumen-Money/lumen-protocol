...
error SupplyError(address supplier, address luToken, uint256 errorCode);

///@notice Error indicating that repaying to given market failed.
error RepayError(address repayer, address luToken, uint256 errorCode);

///@notice Error indicating wNEON address passed is not the expected one.
...
///@notice Error thrown when invalid luToken address is passed to swap router
error LuTokenNotListed(address luToken);

///@notice Error thrown when invalid underlying is passed as per given luToken
error LuTokenUnderlyingInvalid(address underlying);
...
///@notice Error thrown when safeTransferNEON failed
error SafeTransferNEONFailed();

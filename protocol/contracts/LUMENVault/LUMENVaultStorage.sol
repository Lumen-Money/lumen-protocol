...
contract LUMENVaultAdminStorage {
    /**
    ...
    /**
     * @notice Active brains of LUMEN Vault
     */
    address public implementation;

    /**
     * @notice Pending brains of LUMEN Vault
     */
    address public pendingLUMENVaultImplementation;
}

contract LUMENVaultStorageV1 is LUMENVaultAdminStorage {
    /// @notice Guard variable for re-entrancy checks
    bool internal _notEntered;

    /// @notice The reward token store
    address public lumenStore;

    /// @notice The lumen token address
    address public lumenAddress;
...
contract LUMENVaultStorage is LUMENVaultStorageV1 {
